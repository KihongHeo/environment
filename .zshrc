...
if [ $(uname) = 'Linux' ]; then
  ...
  export PATH="$HOME/.dotnet/tools:$HOME/.elan/bin:$HOME/.local/bin:$HOME/go/bin:/snap/bin:$HOME/usr/bin:/sbin:/usr/sbin:/usr/local/sbin:/usr/bin:/usr/local/bin:/usr/lib/jvm/java-8-oracle/bin/:$HOME/.linuxbrew/bin:$PATH"
